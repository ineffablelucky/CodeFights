...
# the bridges on your route home are up, leaving you stranded! Unfortunately, you don't have
#  your watch on you and don't know what time it is. All you know thanks
...
def lateRide(n):
    hh=n//60
    mm=n%60
    return sum([(sum([int(h) for h in str(hh)])),(sum([int(m) for m in str(mm)]))])